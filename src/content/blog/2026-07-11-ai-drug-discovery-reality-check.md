---
title: "AI Drug Discovery: $7 Billion Spent, Zero Drugs Approved. Here's What's Actually Happening."
pubDate: 2026-07-11
...
<div class="note-box">
  <strong>Note:</strong> I asked 10 different LLMs to explain how AI is advancing drug discovery. They all told the same happy story. Then I did my own research. The real story is more interesting — and more honest.
</div>
...
1. Figure out which protein in the body is causing the disease (target identification)
2. Find a molecule that sticks to that protein (hit finding)
3. Make that molecule better — stronger, safer, more stable (lead optimization)
4. Predict whether it'll kill you before you take it (ADMET prediction)
